  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-4 col-sm-offset-4">
        ...
        <img src="../images/tayeba_pic.jpg" class="img-responsive img-circle" alt="Gullur Ma" style="height:250px;">
    ...
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-1">
        ...
        <p class="text-center title-header "> 
          Contact Developer At tayebasadna8@gmail.com
        </p>
